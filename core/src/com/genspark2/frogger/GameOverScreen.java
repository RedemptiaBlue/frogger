...
public class GameOverScreen implements Screen {
    ...
    public GameOverScreen(final Frogger game){
        ...
        TextButton GameOver = new TextButton("Game Over", style);
        GameOver.setPosition(Frogger.gameWidth / 2 - GameOver.getWidth() / 2, Frogger.gameHeight / 2);

        TextButton score = new TextButton(String.format("Last Level: %d; Final Score: %d",game.level, game.score), style);
        score.setPosition(Frogger.gameWidth / 2 - score.getWidth() / 2, Frogger.gameHeight / 2);

        TextButton enterText = new TextButton("Press Enter to try again!", style);
